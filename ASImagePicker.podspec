#
#  Be sure to run `pod spec lint ASImagePicker.podspec' to ensure this is a
...
Highly imitate UIImagePickerController.Support for multiSelect!(Use Photos Framework)
  ...
  # Or just: s.author    = "Alan_Sim"
  # s.authors            = { "Alan_Sim" => "alanshen0118@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Alan_Sim"
 ...
 s.platform     = :ios, "8.0"
  ...
  s.source       = { :git => "https://github.com/alanshen0118/ASImagePicker.git", :tag => "0.0.2" }
